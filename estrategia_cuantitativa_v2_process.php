<?php
	...
	$mmr_rb_41_1 = $_GET["mmr_rb_41_1"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_1);
	$mmr_rb_41_2 = $_GET["mmr_rb_41_2"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_2);
	$mmr_rb_41_3 = $_GET["mmr_rb_41_3"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_3);
	$mmr_rb_41_4 = $_GET["mmr_rb_41_4"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_4);
	$mmr_rb_41_5 = $_GET["mmr_rb_41_5"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_5);
	$mmr_rb_41_6 = $_GET["mmr_rb_41_6"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_6);
	$mmr_rb_41_7 = $_GET["mmr_rb_41_7"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_7);
	$mmr_rb_41_8 = $_GET["mmr_rb_41_8"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_8);
	$mmr_rb_41_9 = $_GET["mmr_rb_41_9"];
	getSqlInsertMmr ($encuestado, $mmr_rb_41_9);
	$mmr_rb_42_1 = $_GET["mmr_rb_42_1"];
	getSqlInsertMmr ($encuestado, $mmr_rb_42_1);
	$mmr_rb_42_2 = $_GET["mmr_rb_42_2"];
	getSqlInsertMmr ($encuestado, $mmr_rb_42_2);
	$mmr_rb_42_3 = $_GET["mmr_rb_42_3"];
	getSqlInsertMmr ($encuestado, $mmr_rb_42_3);
	$mmr_rb_42_4 = $_GET["mmr_rb_42_4"];
	getSqlInsertMmr ($encuestado, $mmr_rb_42_4);
	$mmr_rb_42_5 = $_GET["mmr_rb_42_5"];
	getSqlInsertMmr ($encuestado, $mmr_rb_42_5);
	$mmr_rb_43_1 = $_GET["mmr_rb_43_1"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_1);
	$mmr_rb_43_2 = $_GET["mmr_rb_43_2"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_2);
	$mmr_rb_43_3 = $_GET["mmr_rb_43_3"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_3);
	$mmr_rb_43_4 = $_GET["mmr_rb_43_4"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_4);
	$mmr_rb_43_5 = $_GET["mmr_rb_43_5"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_5);
	$mmr_rb_43_6 = $_GET["mmr_rb_43_6"];
	getSqlInsertMmr ($encuestado, $mmr_rb_43_6);	
	// Cerrar Conexion
