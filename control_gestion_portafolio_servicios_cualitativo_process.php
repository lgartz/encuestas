<?php
	...
	$psu_t_525 = $_GET["psu_t_525"];
	$id_psu_t_525 = "psu_t_525";
	getSqlInsertPsu($encuestado,$id_psu_t_525,$psu_t_525);
	$psu_t_526 = $_GET["psu_t_526"];
	$id_psu_t_526 = "psu_t_526";
	getSqlInsertPsu($encuestado,$id_psu_t_526,$psu_t_526);
	$psu_t_527 = $_GET["psu_t_527"];
	$id_psu_t_527 = "psu_t_527";
	getSqlInsertPsu($encuestado,$id_psu_t_527,$psu_t_527);
	$psu_t_528 = $_GET["psu_t_528"];
	$id_psu_t_528 = "psu_t_528";
	getSqlInsertPsu($encuestado,$id_psu_t_528,$psu_t_528);
	$psu_t_529 = $_GET["psu_t_529"];
	$id_psu_t_529 = "psu_t_529";
	getSqlInsertPsu($encuestado,$id_psu_t_529,$psu_t_529);	
	// Cerrar Conexion
