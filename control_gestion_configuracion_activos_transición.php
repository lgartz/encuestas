...
<body>
	...
	<div class="container">
		<form action="control_gestion_configuracion_activos_transición_process.php" method="GET">
...
<div class="form-group">
	...
	<script type="text/javascript" src="javascript/control_gestion_configuracion_activos_transición.js"></script>
</body>
</html>
