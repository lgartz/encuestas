<?php
	...
	$psu_t_614 = $_GET["psu_t_614"];
	$id_psu_t_614 = "psu_t_614";
	getSqlInsertPsu($encuestado,$id_psu_t_614,$psu_t_614);
	$psu_t_615 = $_GET["psu_t_615"];
	$id_psu_t_615 = "psu_t_615";
	getSqlInsertPsu($encuestado,$id_psu_t_615,$psu_t_615);
	$psu_t_616 = $_GET["psu_t_616"];
	$id_psu_t_616 = "psu_t_616";
	getSqlInsertPsu($encuestado,$id_psu_t_616,$psu_t_616);
	$psu_t_617 = $_GET["psu_t_617"];
	$id_psu_t_617 = "psu_t_617";
	getSqlInsertPsu($encuestado,$id_psu_t_617,$psu_t_617);
	$psu_t_618 = $_GET["psu_t_618"];
	$id_psu_t_618 = "psu_t_618";
	getSqlInsertPsu($encuestado,$id_psu_t_618,$psu_t_618);	
	// Cerrar Conexion
