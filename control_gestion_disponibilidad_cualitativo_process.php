<?php
	...
	$psu_t_555 = $_GET["psu_t_555"];
	$id_psu_t_555 = "psu_t_555";
	getSqlInsertPsu($encuestado,$id_psu_t_555,$psu_t_555);
	$psu_t_556 = $_GET["psu_t_556"];
	$id_psu_t_556 = "psu_t_556";
	getSqlInsertPsu($encuestado,$id_psu_t_556,$psu_t_556);
	$psu_t_557 = $_GET["psu_t_557"];
	$id_psu_t_557 = "psu_t_557";
	getSqlInsertPsu($encuestado,$id_psu_t_557,$psu_t_557);
	$psu_t_558 = $_GET["psu_t_558"];
	$id_psu_t_558 = "psu_t_558";
	getSqlInsertPsu($encuestado,$id_psu_t_558,$psu_t_558);
	$psu_t_559 = $_GET["psu_t_559"];
	$id_psu_t_559 = "psu_t_559";
	getSqlInsertPsu($encuestado,$id_psu_t_559,$psu_t_559);	
	// Cerrar Conexion
