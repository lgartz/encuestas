<?php
	...
	$psu_t_656 = $_GET["psu_t_656"];
	$id_psu_t_656 = "psu_t_656";
	getSqlInsertPsu($encuestado,$id_psu_t_656,$psu_t_656);
	$psu_t_658 = $_GET["psu_t_658"];
	$id_psu_t_658 = "psu_t_658";
	getSqlInsertPsu($encuestado,$id_psu_t_658,$psu_t_658);
	$psu_t_660 = $_GET["psu_t_660"];
	$id_psu_t_660 = "psu_t_660";
	getSqlInsertPsu($encuestado,$id_psu_t_660,$psu_t_660);
	$psu_t_662 = $_GET["psu_t_662"];
	$id_psu_t_662 = "psu_t_662";
	getSqlInsertPsu($encuestado,$id_psu_t_662,$psu_t_662);
	$psc_ta_657 = $_GET["psc_ta_657"];
	$id_psc_ta_657 = "psc_ta_657";
	getSqlInsertPsu($encuestado,$id_psc_ta_657,$psc_ta_657);
	$psc_ta_659 = $_GET["psc_ta_659"];
	$id_psc_ta_659 = "psc_ta_659";
	getSqlInsertPsu($encuestado,$id_psc_ta_659,$psc_ta_659);
	$psc_ta_661 = $_GET["psc_ta_661"];
	$id_psc_ta_661 = "psc_ta_661";
	getSqlInsertPsu($encuestado,$id_psc_ta_661,$psc_ta_661);	
	// Cerrar Conexion
