<?php
	...
	$psu_t_663 = $_GET["psu_t_663"];
	$id_psu_t_663 = "psu_t_663";
	getSqlInsertPsu($encuestado,$id_psu_t_663,$psu_t_663);
	$psu_t_664 = $_GET["psu_t_664"];
	$id_psu_t_664 = "psu_t_664";
	getSqlInsertPsu($encuestado,$id_psu_t_664,$psu_t_664);
	$psu_t_665 = $_GET["psu_t_665"];
	$id_psu_t_665 = "psu_t_665";
	getSqlInsertPsu($encuestado,$id_psu_t_665,$psu_t_665);
	$psu_t_666 = $_GET["psu_t_666"];
	$id_psu_t_666 = "psu_t_666";
	getSqlInsertPsu($encuestado,$id_psu_t_666,$psu_t_666);
	$psu_t_667 = $_GET["psu_t_667"];
	$id_psu_t_667 = "psu_t_667";
	getSqlInsertPsu($encuestado,$id_psu_t_667,$psu_t_667);
	$psu_t_668 = $_GET["psu_t_668"];
	$id_psu_t_668 = "psu_t_668";
	getSqlInsertPsu($encuestado,$id_psu_t_668,$psu_t_668);	
	// Cerrar Conexion
