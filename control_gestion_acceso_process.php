<?php
	...
	$psu_t_669 = $_GET["psu_t_669"];
	$id_psu_t_669 = "psu_t_669";
	getSqlInsertPsu($encuestado,$id_psu_t_669,$psu_t_669);
	$psu_t_670 = $_GET["psu_t_670"];
	$id_psu_t_670 = "psu_t_670";
	getSqlInsertPsu($encuestado,$id_psu_t_670,$psu_t_670);
	$psu_t_671 = $_GET["psu_t_671"];
	$id_psu_t_671 = "psu_t_671";
	getSqlInsertPsu($encuestado,$id_psu_t_671,$psu_t_671);
	$psu_t_672 = $_GET["psu_t_672"];
	$id_psu_t_672 = "psu_t_672";
	getSqlInsertPsu($encuestado,$id_psu_t_672,$psu_t_672);
	$psu_t_673 = $_GET["psu_t_673"];
	$id_psu_t_673 = "psu_t_673";
	getSqlInsertPsu($encuestado,$id_psu_t_673,$psu_t_673);	
	// Cerrar Conexion
