<?php
	...
	$psu_t_530 = $_GET["psu_t_530"];
	$id_psu_t_530 = "psu_t_530";
	getSqlInsertPsu($encuestado,$id_psu_t_530,$psu_t_530);
	$psu_t_531 = $_GET["psu_t_531"];
	$id_psu_t_531 = "psu_t_531";
	getSqlInsertPsu($encuestado,$id_psu_t_531,$psu_t_531);
	$psu_t_532 = $_GET["psu_t_532"];
	$id_psu_t_532 = "psu_t_532";
	getSqlInsertPsu($encuestado,$id_psu_t_532,$psu_t_532);
	$psu_t_533 = $_GET["psu_t_533"];
	$id_psu_t_533 = "psu_t_533";
	getSqlInsertPsu($encuestado,$id_psu_t_533,$psu_t_533);	
	// Cerrar Conexion
