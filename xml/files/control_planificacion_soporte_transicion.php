...
<body>
	...
	<div class="container">
		<form action="control_planificacion_soporte_transicion_process.php" method="GET">
...
<div class="form-group">
	...
	<script type="text/javascript" src="javascript/control_planificacion_soporte_transicion.js"></script>
</body>
</html>
