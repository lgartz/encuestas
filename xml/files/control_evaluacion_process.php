<?php
	...
	$psu_t_619 = $_GET["psu_t_619"];
	$id_psu_t_619 = "psu_t_619";
	getSqlInsertPsu($encuestado,$id_psu_t_619,$psu_t_619);
	$psu_t_620 = $_GET["psu_t_620"];
	$id_psu_t_620 = "psu_t_620";
	getSqlInsertPsu($encuestado,$id_psu_t_620,$psu_t_620);
	$psu_t_621 = $_GET["psu_t_621"];
	$id_psu_t_621 = "psu_t_621";
	getSqlInsertPsu($encuestado,$id_psu_t_621,$psu_t_621);
	$psu_t_622 = $_GET["psu_t_622"];
	$id_psu_t_622 = "psu_t_622";
	getSqlInsertPsu($encuestado,$id_psu_t_622,$psu_t_622);
	$psu_t_623 = $_GET["psu_t_623"];
	$id_psu_t_623 = "psu_t_623";
	getSqlInsertPsu($encuestado,$id_psu_t_623,$psu_t_623);	
	// Cerrar Conexion
