...
-- Table `mydb`.`opsmu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`opsmu` (
...
-- -----------------------------------------------------
-- Table `mydb`.`encuesta_has_pregunta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`encuesta_has_pregunta` (
  `pregunta_id` VARCHAR(20) NOT NULL COMMENT '',
  `encuesta_id` INT NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `mydb`.`encuestado_has_encuesta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`encuestado_has_encuesta` (
  `encuestado_id` INT NOT NULL COMMENT '',
  `encuesta_id` INT NOT NULL COMMENT '',
...
-- Table `mydb`.`ressmu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ressmu` (
  ...
  CONSTRAINT `fk_ressmurb_opsmurb1`
    ...
    REFERENCES `mydb`.`opsmu` (`opsmu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`reseru`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`reseru` (
...
-- Table `mydb`.`respsu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`respsu` (
...
-- Table `mydb`.`mmrrow`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`mmrrow` (
...
-- Table `mydb`.`opmmr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`opmmr` (
  ...
  CONSTRAINT `fk_opmmr_mmrrow1`
    ...
    REFERENCES `mydb`.`mmrrow` (`mmrrow_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`resmmr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`resmmr` (
  ...
  CONSTRAINT `fk_resmmr_opmmr1`
    ...
    REFERENCES `mydb`.`opmmr` (`opmmr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `mydb`.`respfh`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`respfh` (
...
-- Table `mydb`.`mmrcol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`mmrcol` (
...
-- Table `mydb`.`opmmrs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`opmmrs` (
  ...
  CONSTRAINT `fk_opmmrs_mmrcol1`
    ...
    REFERENCES `mydb`.`mmrcol` (`mmrcol_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `mydb`.`resmmrs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`resmmrs` (
  ...
  CONSTRAINT `fk_resmmrs_opmmrs1`
    ...
    REFERENCES `mydb`.`opmmrs` (`opmmrs_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
