...
-- -----------------------------------------------------
-- Table `prueba`.`opsmurb`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`opsmurb` (
...
-- -----------------------------------------------------
-- Table `prueba`.`ressmurb`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`ressmurb` (
  ...
  CONSTRAINT `fk_ressmurb_opsmurb1`
    ...
    REFERENCES `prueba`.`opsmurb` (`opsmurb_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
