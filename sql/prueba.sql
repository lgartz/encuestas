...
-- Table `prueba`.`mmrrow`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`mmrrow` (
...
-- Table `prueba`.`opmmr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`opmmr` (
  ...
  CONSTRAINT `fk_opmmr_mmrrow1`
    ...
    REFERENCES `prueba`.`mmrrow` (`mmrrow_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `prueba`.`resmmr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`resmmr` (
  ...
  CONSTRAINT `fk_resmmr_opmmr1`
    ...
    REFERENCES `prueba`.`opmmr` (`opmmr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `prueba`.`mmrcol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`mmrcol` (
...
-- Table `prueba`.`opmmrs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`opmmrs` (
  ...
  CONSTRAINT `fk_opmmrs_mmrcol1`
    ...
    REFERENCES `prueba`.`mmrcol` (`mmrcol_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `prueba`.`resmmrs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`resmmrs` (
  ...
  CONSTRAINT `fk_resmmrs_opmmrs1`
    ...
    REFERENCES `prueba`.`opmmrs` (`opmmrs_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
