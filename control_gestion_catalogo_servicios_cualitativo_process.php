<?php
	...
	$psu_t_534 = $_GET["psu_t_534"];
	$id_psu_t_534 = "psu_t_534";
	getSqlInsertPsu($encuestado,$id_psu_t_534,$psu_t_534);
	$psu_t_535 = $_GET["psu_t_535"];
	$id_psu_t_535 = "psu_t_535";
	getSqlInsertPsu($encuestado,$id_psu_t_535,$psu_t_535);
	$psu_t_536 = $_GET["psu_t_536"];
	$id_psu_t_536 = "psu_t_536";
	getSqlInsertPsu($encuestado,$id_psu_t_536,$psu_t_536);
	$psu_t_698 = $_GET["psu_t_698"];
	$id_psu_t_698 = "psu_t_698";
	getSqlInsertPsu($encuestado,$id_psu_t_698,$psu_t_698);	
	// Cerrar Conexion
