<?php
	...
	$psu_t_579 = $_GET["psu_t_579"];
	$id_psu_t_579 = "psu_t_579";
	getSqlInsertPsu($encuestado,$id_psu_t_579,$psu_t_579);
	$psu_t_580 = $_GET["psu_t_580"];
	$id_psu_t_580 = "psu_t_580";
	getSqlInsertPsu($encuestado,$id_psu_t_580,$psu_t_580);
	$psu_t_581 = $_GET["psu_t_581"];
	$id_psu_t_581 = "psu_t_581";
	getSqlInsertPsu($encuestado,$id_psu_t_581,$psu_t_581);
	$psu_t_582 = $_GET["psu_t_582"];
	$id_psu_t_582 = "psu_t_582";
	getSqlInsertPsu($encuestado,$id_psu_t_582,$psu_t_582);
	$psu_t_583 = $_GET["psu_t_583"];
	$id_psu_t_583 = "psu_t_583";
	getSqlInsertPsu($encuestado,$id_psu_t_583,$psu_t_583);	
	// Cerrar Conexion
