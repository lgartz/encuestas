<?php
	...
	$psu_t_569 = $_GET["psu_t_569"];
	$id_psu_t_569 = "psu_t_569";
	getSqlInsertPsu($encuestado,$id_psu_t_569,$psu_t_569);
	$psu_t_570 = $_GET["psu_t_570"];
	$id_psu_t_570 = "psu_t_570";
	getSqlInsertPsu($encuestado,$id_psu_t_570,$psu_t_570);
	$psu_t_571 = $_GET["psu_t_571"];
	$id_psu_t_571 = "psu_t_571";
	getSqlInsertPsu($encuestado,$id_psu_t_571,$psu_t_571);	
	// Cerrar Conexion
