<?php
	...
	$psu_t_545 = $_GET["psu_t_545"];
	$id_psu_t_545 = "psu_t_545";
	getSqlInsertPsu($encuestado,$id_psu_t_545,$psu_t_545);
	$psu_t_546 = $_GET["psu_t_546"];
	$id_psu_t_546 = "psu_t_546";
	getSqlInsertPsu($encuestado,$id_psu_t_546,$psu_t_546);
	$psu_t_547 = $_GET["psu_t_547"];
	$id_psu_t_547 = "psu_t_547";
	getSqlInsertPsu($encuestado,$id_psu_t_547,$psu_t_547);
	$psu_t_548 = $_GET["psu_t_548"];
	$id_psu_t_548 = "psu_t_548";
	getSqlInsertPsu($encuestado,$id_psu_t_548,$psu_t_548);
	$psu_t_549 = $_GET["psu_t_549"];
	$id_psu_t_549 = "psu_t_549";
	getSqlInsertPsu($encuestado,$id_psu_t_549,$psu_t_549);
	$psu_t_550 = $_GET["psu_t_550"];
	$id_psu_t_550 = "psu_t_550";
	getSqlInsertPsu($encuestado,$id_psu_t_550,$psu_t_550);
	$psu_t_551 = $_GET["psu_t_551"];
	$id_psu_t_551 = "psu_t_551";
	getSqlInsertPsu($encuestado,$id_psu_t_551,$psu_t_551);
	$psu_t_552 = $_GET["psu_t_552"];
	$id_psu_t_552 = "psu_t_552";
	getSqlInsertPsu($encuestado,$id_psu_t_552,$psu_t_552);
	$psu_t_553 = $_GET["psu_t_553"];
	$id_psu_t_553 = "psu_t_553";
	getSqlInsertPsu($encuestado,$id_psu_t_553,$psu_t_553);
	$psu_t_554 = $_GET["psu_t_554"];
	$id_psu_t_554 = "psu_t_554";
	getSqlInsertPsu($encuestado,$id_psu_t_554,$psu_t_554);	
	// Cerrar Conexion
